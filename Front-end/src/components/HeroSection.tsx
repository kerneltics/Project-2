...
export const HeroSection = () => {
  return (
    <div className="h-[760px] md:h-[500px]">
      <div className="bg-hero absolute inset-0 -z-10 h-[760px] bg-cover bg-center md:top-28  md:h-[500px]" />
      ...
      <SubHeading className="m-auto my-5 max-w-[50ch] text-center text-[18px] font-normal text-muted-foreground md:text-[30px]">
